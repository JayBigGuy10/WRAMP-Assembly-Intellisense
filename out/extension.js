...
function activate(context) {
    const provider1 = vscode.languages.registerCompletionItemProvider('wramp', {
        provideCompletionItems(document, position, token, context) {
            ...
            const addDocs = new vscode.MarkdownString();
...
* Generate an overflow exception on signed overflow`);
            ...
            const addiDocs = new vscode.MarkdownString();
...
* Generate an overflow exception on signed overflow`);
            ...
            const adduDocs = new vscode.MarkdownString();
...
* Generate an overflow exception on unsigned overflow`);
            ...
            const adduiDocs = new vscode.MarkdownString();
...
* Generate an overflow exception on unsigned overflow`);
            ...
            const subDocs = new vscode.MarkdownString();
...
* Generate an overflow exception on signed overflow`);
            ...
            const subiDocs = new vscode.MarkdownString();
...
* Generate an overflow exception on signed overflow`);
            ...
            const subuDocs = new vscode.MarkdownString();
...
* Generate an overflow exception on unsigned overflow`);
            ...
            const subuiDocs = new vscode.MarkdownString();
...
* Generate an overflow exception on unsigned overflow`);
            ...
            const multDocs = new vscode.MarkdownString();
...
* Generate an overflow exception on signed overflow`);
            ...
            const multiDocs = new vscode.MarkdownString();
...
* Generate an overflow exception on signed overflow`);
            ...
            const multuDocs = new vscode.MarkdownString();
...
* Generate an overflow exception on unsigned overflow`);
            ...
            const multuiDocs = new vscode.MarkdownString();
...
* Generate an overflow exception on unsigned overflow`);
            ...
            const divDocs = new vscode.MarkdownString();
...
* Generate a divide-by-zero exception if the contents of Rt is zero`);
            ...
            const diviDocs = new vscode.MarkdownString();
...
* Generate a divide-by-zero exception if the immediate value is zero`);
            ...
            const divuDocs = new vscode.MarkdownString();
...
* Generate a divide-by-zero exception if the contents of Rt is zero`);
            ...
            const divuiDocs = new vscode.MarkdownString();
...
* Generate a divide-by-zero exception if the immediate value is zero`);
            ...
            const remDocs = new vscode.MarkdownString();
...
* Generate a divide-by-zero exception if the contents of Rt is zero`);
            ...
            const remiDocs = new vscode.MarkdownString();
...
* Generate a divide-by-zero exception if the immediate value is zero`);
            ...
            const remuDocs = new vscode.MarkdownString();
...
* Generate a divide-by-zero exception if the contents of Rt is zero`);
            ...
            const remuiDocs = new vscode.MarkdownString();
...
* Generate a divide-by-zero exception if the immediate value is zero`);
            ...
            const lhiDocs = new vscode.MarkdownString();
...
* Put the 16 bit immediate into the upper 16 bits of register Rd, and set the lower 16 bits to zero`);
            ...
            const laDocs = new vscode.MarkdownString();
...
* Put the zero-extended 20 bit address into register Rd`);
            ...
            const andDocs = new vscode.MarkdownString();
...
* Put the result of the logical AND of registers Rs and Rt into register Rd`);
            ...
            const andiDocs = new vscode.MarkdownString();
...
* Put the result of the logical AND of register Rs and the zero-extended immediate into register Rd`);
            ...
            const orDocs = new vscode.MarkdownString();
...
* Put the result of the logical OR of registers Rs and Rt into register Rd`);
            ...
            const oriDocs = new vscode.MarkdownString();
...
* Put the result of the logical OR of register Rs and the zero-extended immediate into register Rd`);
            ...
            const xorDocs = new vscode.MarkdownString();
...
* Put the result of the logical exclusive-OR of registers Rs and Rt into register Rd`);
            ...
            const xoriDocs = new vscode.MarkdownString();
...
* Put the result of the logical exclusive-OR of register Rs and the zero-extended immediate into register Rd`);
            ...
            const sllDocs = new vscode.MarkdownString();
...
* Shift the value in register Rs left by the unsigned value given by the least significant 5 bits of register Rt, and put the result in register Rd, inserting zeros into the low order bits`);
            ...
            const slliDocs = new vscode.MarkdownString();
...
* Shift the value in register Rs left by the unsigned value given by the least significant 5 bits of the immediate, and put the result in register Rd, inserting zeros into the low order bits`);
            ...
            const srlDocs = new vscode.MarkdownString();
...
* Shift the value in register Rs right by the unsigned value given by the least significant 5 bits of register Rt, and place the result in register Rd, inserting zeros into the high order bits`);
            ...
            const srliDocs = new vscode.MarkdownString();
...
* Shift the value in register Rs right by the unsigned value given by the least significant 5 bits of the immediate, and place the result in register Rd, inserting zeros into the high order bits`);
            ...
            const sraDocs = new vscode.MarkdownString();
...
* Shift the value in register Rs right by the unsigned value given by the least significant 5 bits of register Rt, and place the result in register Rd, sign-extending the high order bits`);
            ...
            const sraiDocs = new vscode.MarkdownString();
...
* Shift the value in register Rs right by the unsigned value given by the least significant 5 bits of the immediate, and place the result in register Rd, sign-extending the high order bits`);
            ...
            const sltDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is less than register Rt according to a signed comparison, and 0 otherwise`);
            ...
            const sltiDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is less than the sign-extended immediate according to a signed comparison, and 0 otherwise`);
            ...
            const sltuDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is less than register Rt according to an unsigned comparison, and 0 otherwise`);
            ...
            const sltuiDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is less than the zero-extended immediate according to an unsigned comparison, and 0 otherwise`);
            ...
            const sgtDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is greater than register Rt according to a signed comparison, and 0 otherwise`);
            ...
            const sgtiDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is greater than the sign-extended immediate according to a signed comparison, and 0 otherwise`);
            ...
            const sgtuDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is greater than register Rt according to an unsigned comparison, and 0 otherwise`);
            ...
            const sgtuiDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is greater than the zero-extended immediate according to an unsigned comparison, and 0 otherwise`);
            ...
            const sleDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is less than or equal to register Rt according to a signed comparison, and 0 otherwise`);
            ...
            const sleiDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is less than or equal to the sign-extended immediate according to a signed comparison, and 0 otherwise`);
            ...
            const sleuDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is less than or equal to register Rt according to an unsigned comparison, and 0 otherwise`);
            ...
            const sleuiDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is less than or equal to the zero-extended immediate according to an unsigned comparison, and 0 otherwise`);
            ...
            const sgeDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is greater than or equal to register Rt according to a signed comparison, and 0 otherwise`);
            ...
            const sgeiDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is greater than or equal to the sign-extended immediate according to a signed comparison, and 0 otherwise`);
            ...
            const sgeuDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is greater than or equal to register Rt according to an unsigned comparison, and 0 otherwise`);
            ...
            const sgeuiDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is greater than or equal to the zero-extended immediate according to an unsigned comparison, and 0 otherwise`);
            ...
            const seqDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is equal to register Rt according to a signed comparison, and 0 otherwise`);
            ...
            const seqiDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is equal to the sign-extended immediate according to a signed comparison, and 0 otherwise`);
            ...
            const sequDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is equal to register Rt according to an unsigned comparison, and 0 otherwise`);
            ...
            const sequiDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is equal to the zero-extended immediate according to an unsigned comparison, and 0 otherwise`);
            ...
            const sneDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is not equal to register Rt according to a signed comparison, and 0 otherwise`);
            ...
            const sneiDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is not equal to the sign-extended immediate according to a signed comparison, and 0 otherwise`);
            ...
            const sneuDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is not equal to register Rt according to an unsigned comparison, and 0 otherwise`);
            ...
            const sneuiDocs = new vscode.MarkdownString();
...
* Set register Rd to 1 if register Rs is not equal to the zero-extended immediate according to an unsigned comparison, and 0 otherwise`);
            ...
            const jDocs = new vscode.MarkdownString();
...
* Unconditionally jump to the instruction whose address is given by the address field`);
            ...
            const jrDocs = new vscode.MarkdownString();
...
* Unconditionally jump to the instruction whose address is in the least significant 20 bits of register Rs`);
            ...
            const jalDocs = new vscode.MarkdownString();
...
* Save the address of the next instruction in register $ra`);
            ...
            const jalrDocs = new vscode.MarkdownString();
...
* Save the address of the next instruction in register $ra`);
            ...
            const beqzDocs = new vscode.MarkdownString();
...
* Conditionally branch the number of instructions specified by the sign-extended offset if register Rs is equal to 0`);
            ...
            const bnezDocs = new vscode.MarkdownString();
...
* Conditionally branch the number of instructions specified by the sign-extended offset if register Rs is not equal to 0`);
            ...
            const lwDocs = new vscode.MarkdownString();
...
* Load the contents of the memory location specified by this effective address into register Rd`);
            ...
            const swDocs = new vscode.MarkdownString();
...
* Store the contents of register Rd into the memory location specified by this effective address`);
            ...
            const movgsDocs = new vscode.MarkdownString();
...
* Copy the contents of general purpose register Rs into special purpose register Rd`);
            ...
            const movsgDocs = new vscode.MarkdownString();
...
* Copy the contents of special purpose register Rs into general purpose register Rd`);
            ...
            const breakDocs = new vscode.MarkdownString();
...
* Generate a breakpoint exception, transferring control to the exception handler`);
            ...
            const syscallDocs = new vscode.MarkdownString();
...
* Generate a system call exception, transferring control to the exception handler`);
            ...
            const rfeDocs = new vscode.MarkdownString();
...
* Restore the saved interrupt enable and kernel/user mode bits and jump to the instruction at the address specified in the special register $ear `);
    ...
    const provider2 = vscode.languages.registerCompletionItemProvider('wramp', {
        provideCompletionItems(document, position) {
            ...
            const textLabelDocs = new vscode.MarkdownString(`The .text section contains WRAMP assembly instructions which will be converted to machine language
            ...
            const dataLabelDocs = new vscode.MarkdownString(`Within the .data section, space in the memory can be reserved and initialised.
            ...
            const wordLabelDocs = new vscode.MarkdownString(`.word n assigns one word of memory space and initialises it to the number n. If a character is provided
            ...
            const bssLabelDocs = new vscode.MarkdownString(`The .bss section allows memory space to be reserved but not initialised. 
            ...
            const asciizLabelDocs = new vscode.MarkdownString(`.asciiz "str" reserves and initialises space for a NULL terminated ASCII string ("str"). This means
            ...
            const asciiLabelDocs = new vscode.MarkdownString(`.ascii "str" reserves and initialises space for the ASCII string "str" without NULL terminating.`);
            ...
            const spaceLabelDocs = new vscode.MarkdownString(`.space n is used to allocate a chunk of space of size n in the .bss section.`);
            ...
            const globalLabelDocs = new vscode.MarkdownString(`When linking multiple files, we need to share functions and data. However, we do not want to expose all
            ...
            const equLabelDocs = new vscode.MarkdownString(`The .equ directive will create a named constant, which is simply an alias to a number.
    ...
    const provider3 = vscode.languages.registerCompletionItemProvider('wramp', {
        provideCompletionItems(document, position) {
            // get all text until the `position` and check if it reads `console.`
            // and if so then complete if `log`, `warn`, and `error`
            const linePrefix = document.lineAt(position).text.substr(0, position.character);
            ...
            const textLabelDocs = new vscode.MarkdownString(`Allows extra WRAMP language files to be specified for assembly, current file is included by default. Don't include file extensions. Place at top of file.`);
            wasmLabel.documentation = textLabelDocs;
            const wlinkLabel = new vscode.CompletionItem('wlink');
            const dataLabelDocs = new vscode.MarkdownString(`Allows other files to be specified for linking with the current file, current file included by default. Don't include file extensions. Place at top of file`);
...
* Restore the saved interrupt enable and kernel/user mode bits and jump to the instruction at the address specified in the special register $ear `);
    ...
    const build = vscode.commands.registerCommand("wramp.build", (fileUri) => {
        ...
        if (commentLineOne != undefined && commentLineTwo != undefined) {
            ...
            codeManager.run(fileUri, wasmArgs, wlinkArgs, context.extensionUri, false);
        }
    });
    context.subscriptions.push(build);
    const buildAndRun = vscode.commands.registerCommand("wramp.buildAndRun", (fileUri) => {
        //reset path string
        //only works on jaydens zephyurus, obvs
        //context.environmentVariableCollection.replace("PATH","PATH=C:\\Python311\\Scripts\\;C:\\Python311\\;D:\\Oculus\\Support\\oculus-runtime;C:\\Windows\\system32;C:\\Windows;C:\\Windows\\System32\\Wbem;C:\\Windows\\System32\\WindowsPowerShell\\v1.0\\;C:\\Windows\\System32\\OpenSSH\\;C:\\Program Files (x86)\\NVIDIA Corporation\\PhysX\\Common;C:\\Program Files\\Microsoft VS Code\\bin;C:\\Program Files\\Git\\cmd;C:\\Program Files\\Git LFS;C:\\Program Files (x86)\\Tailscale IPN;C:\\Program Files\\NVIDIA Corporation\\NVIDIA NvDLISR;C:\\Program Files\\Microsoft SQL Server\\150\\Tools\\Binn\\;C:\\Program Files\\Microsoft SQL Server\\Client SDK\\ODBC\\170\\Tools\\Binn\\;C:\\Program Files\\dotnet\\;C:\\Program Files (x86)\\PDFtk\\bin\\;C:\\Program Files\\MATLAB\\R2022b\\bin;C:\\Program Files (x86)\\Microsoft SQL Server\\160\\Tools\\Binn\\;C:\\Program Files\\Microsoft SQL Server\\160\\Tools\\Binn\\;C:\\Program Files\\Microsoft SQL Server\\160\\DTS\\Binn\\;C:\\Program Files (x86)\\Microsoft SQL Server\\160\\DTS\\Binn\\;C:\\Program Files\\Azure Data Studio\\bin;C:\\Users\\Jayden Litolff\\Documents\\Uni\\COMPX203\\toolchain-win-3.0.1[UNZIP];C:\\Users\\Jayden Litolff\\AppData\\Local\\Microsoft\\WindowsApps;C:\\Users\\Jayden;C:\\Program Files\\nodejs\\;C:\\ProgramData\\chocolatey\\bin;C:\\Users\\Jayden Litolff\\AppData\\Local\\Microsoft\\WindowsApps;C:\\Users\\Jayden Litolff\\.dotnet\\tools;C:\\Program Files\\Azure Data Studio\\bin;C:\\Users\\Jayden Litolff\\Documents\\Uni\\COMPX203\\toolchain-win-3.0.1;C:\\Users\\Jayden Litolff\\AppData\\Roaming\\npm");
        const commentLineOne = vscode.window.activeTextEditor?.document.lineAt(0).text;
        ...
        if (commentLineOne != undefined && commentLineTwo != undefined) {
            ...
            codeManager.run(fileUri, wasmArgs, wlinkArgs, context.extensionUri, true);
        }
    });
...
function getCommandCount(editor) {
...
function addMessageToProblemView(message, severity, popup = true) {
